...
- Adjust :
	* Parameter: NGX, NGY (number of grid points in longitude and latitude direction), NF and ND (number of frequencies and directions as stated in read_cfo_nc.f90)
	* Parameter: XDELLA, XDELLO, AMOSOP, AMONOP, AMOWEP and AMOEAP for your domain
...
4. 	Running command = ./lance_cfo_nc.sh
