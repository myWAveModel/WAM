...
&                                MOUTT, COUTT, NOUT_SCR, CFLAG_SCR,                &
...
IF (IOS.EQ.0) THEN
   ...
   ELSE
      WRITE (IU06,*) ' ++++++++++++++++++++++++++++++++++++++++++++++++++++'
      WRITE (IU06,*) ' +                                                  +'
      WRITE (IU06,*) ' +      INFORMATION FROM SUB. READ_GRID_USER        +'
      WRITE (IU06,*) ' +      ====================================        +'
      WRITE (IU06,*) ' +                                                  +'
      WRITE (IU06,*) ' + THE GRID USER FILE COULD BE OPENED.              +'
...
ELSE
   WRITE (IU06,*) ' ++++++++++++++++++++++++++++++++++++++++++++++++++++'
   WRITE (IU06,*) ' +                                                  +'
   WRITE (IU06,*) ' +      INFORMATION FROM SUB. READS_GRID_USER       +'
   WRITE (IU06,*) ' +      =====================================       +'
   WRITE (IU06,*) ' +                                                  +'
   WRITE (IU06,*) ' + THE GRID USER FILE COULD NOT BE OPENED.          +'
   WRITE (IU06,*) ' + GRID USER FILE NAME IS FILE05 = ', TRIM(FILE05)
   WRITE (IU06,*) ' +         UNIT IS         IU05 = ', IU05
   WRITE (IU06,*) ' +                                                  +'
   ...
   IF (IOS.NE.0) THEN
      WRITE (IU06,*) ' ****************************************************'
      WRITE (IU06,*) ' *                                                  *'
      WRITE (IU06,*) ' *     FATAL ERROR IN SUB. READ_PRINT_NAMELIST      *'
      WRITE (IU06,*) ' *     =======================================      *'
      WRITE (IU06,*) ' *                                                  *'
...
DO I= 1,NOUT_SCR,2
   CALL F_NEW_DATA
   CFLAG_SCR(  I) = .NOT. (LINE( 2: 2).EQ.'N' .OR. LINE( 2: 2).EQ.'n')
   CFLAG_SCR(I+1) = .NOT. (LINE(38:38).EQ.'N' .OR. LINE(38:38).EQ.'n')
END DO

! ---------------------------------------------------------------------------- !
!                                                                              !
!     6. FIRST INPUT FILE DATE AND INCREMENT.                                  !
!        ------------------------------------                                  !
...
! ---------------------------------------------------------------------------- !
!                                                                              !
!     8. TRANSFER DATA TO WAM_PRINT_MODULE.                                    !
!        ----------------------------------                                    !
