...
use WAM_OASIS_MODULE,	only:	Wam_oasis_write_part
...
USE WAM_TIMOPT_MODULE,        ONLY: CDTPRO, IPHYS
...
use WAM_OASIS_MODULE,	only:	use_oasis,use_oasis_bdy_in,use_oasis_nest_out, &
...
IF(use_oasis)CALL Wam_oasis_write_part
...
IF (COARSE.OR.FINE.or.use_oasis_bdy_in.or.use_oasis_nest_out) THEN
...
! ---------------------------------------------------------------------------- !
!                                                                              !
!     9. INITIALIZE SOURCE COMPUTATIONS AND OUTPUT.                         !
!        ---------------------                                                 !
