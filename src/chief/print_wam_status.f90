...
USE WAM_GENERAL_MODULE,       ONLY: PRINT_GENERAL_MODULE
...
USE WAM_SOURCE_OUTPUT_MODULE, ONLY: PRINT_SOURCE_OUTPUT_MODULE !! ModR05: Include SRC-OUT

USE WAM_TABLES_MODULE,        ONLY: PRINT_TABLES_STATUS
...
CALL PRINT_SOURCE_OUTPUT_MODULE !! ModR05: Include SRC-OUT
