...
use wam_oasis_module,     only: use_oasis,Wam_oasis_init_comp,Wam_oasis_terminate
! ---------------------------------------------------------------------------- !
!                                                                              !
!     MODULE VARIABLES.                                                        !
!     -----------------                                                        !
...
&                            irank, extime, comtime, localcomm
USE WAM_GENERAL_MODULE,ONLY: ABORTCASE  !! ALSO TERMINATE MPI(1) OR OASIS(2)
...
CALL MPI_COMM_RANK (localcomm, pelocal, ierr)
CALL MPI_COMM_SIZE (localcomm, petotal, ierr)
