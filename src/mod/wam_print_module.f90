...
LOGICAL, DIMENSION(NOUT_SCR) :: CFLAG_SCR     !! SOURCE OUTPUT FLAG.
LOGICAL, DIMENSION(NOUT_SCR) :: PFLAG_SCR     !! FLAG OF DATA IN MODULE.
...
INTERFACE SET_SCR_OUTPUT_FLAGS
...
SUBROUTINE SET_SCR_OUTPUT_FLAGS (PF)
...
END SUBROUTINE SET_SCR_OUTPUT_FLAGS
