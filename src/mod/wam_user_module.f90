...
USE WAM_OUTPUT_SET_UP_MODULE, ONLY: NOUT_P,NOUT_S,NOUT_SOURCE=>NOUT_SCR
...
LOGICAL, DIMENSION(NOUT_SOURCE) :: FFLAG_SOURCE         !! FILE OUTPUT FLAG.
LOGICAL, DIMENSION(NOUT_SOURCE) :: PFLAG_SOURCE         !! PRINTER OUTPUT FLAG.
...
&       OUTLAT,   OUTLONG,   NAME,                                             &
&       SOURCE_OUTPUT_TIMESTEP,     SOURCE_OUTPUT_TIMESTEP_UNIT,               &
&       SOURCE_FILE_TIMESTEP,       SOURCE_FILE_TIMESTEP_UNIT,                 &
&       SOURCE_OUTPUT_FILE_UNIT,    SOURCE_OUTPUT_FILE_NAME,                   &
&       FFLAG_SOURCE,               PFLAG_SOURCE,                              &
...
IF (USE_OASIS_ELEV_IN.OR.USE_OASIS_CURR_IN) THEN
