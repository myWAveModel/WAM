...
!                                                                              !
! ---------------------------------------------------------------------------- !
use wam_oasis_module,only:	use_oasis_bdy_in,use_oasis_nest_out
!                                                                              !
!     LOCAL VARIABLES.                                                         !
!     ----------------                                                         !
...
IF (.not.(COARSE.or.FINE.or.use_oasis_bdy_in.or.use_oasis_nest_out)) RETURN
...
IF (COARSE.or.use_oasis_nest_out) THEN
...
IF (FINE.or.use_oasis_bdy_in) THEN
