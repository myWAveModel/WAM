...
USE WAM_GENERAL_MODULE,ONLY: G, ZPI, DEG, RCHAR, ROAIR
...
IF (CFLAG_P(4).OR.CFLAG_P(16)) THEN
   ...
   IF (CFLAG_P(16)) BLOCK(NIJS:NIJL,16) = TAUW(:)/(TAU(:)*ROAIR)
END IF
...
IF (CFLAG_P(9).OR.ANY(CFLAG_P(11:13)).OR.CFLAG_P(40)) THEN
   CALL TOTAL_ENERGY (FL3, BLOCK(NIJS:NIJL,9))
   IF (CFLAG_P(11).OR.CFLAG_P(40)) THEN
